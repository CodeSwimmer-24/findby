  ...
  const apartments = [
    {
      ...
      price: "₹ 34,000/month",
      image:
        "https://plus.unsplash.com/premium_photo-1676823553207-758c7a66e9bb?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8cm9vbSUyMGZvciUyMHJlbnR8ZW58MHx8MHx8fDA%3D",
    },
    {
      id: 2,
      name: "Seaside Villa",
    ...
    <ScrollView contentContainerStyle={styles.container}>
      {apartments.map((apartment) => (
        <TouchableOpacity
          ...
          style={styles.card}
          onPress={() =>
            navigation.navigate("PropertyDetails", { card: apartment })
          }
        >
          {/* Property Image */}
          <View
